...
def reload():
    ...
    canvas4.create_text(80, 60,font=("Ariel",12), text="Total Memory: {:0.2f} GB".format(monitor_ram_total / 1073741824))
    ...
    canvas6.create_text(120,40,font=("Ariel",12), text="Total Bytes sent: {:0.3f} Kbps".format(monitor_network_sent/1024))
    ...
    canvas7.create_text(240,70, font=("Ariel",10), text="{}".format(gpu.info()))
   ...
   # def exit():
    ...
    #btn_exit =tk.Button(root, text="EXIT", command=exit,bg="Red", fg="white",)
