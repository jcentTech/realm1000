...
def reload():
    ...
    #Division of Canvas
    canvas1 = Canvas(root, width=450, height=170, bg="black")
    canvas1.grid(row=1,column=0)
    
    canvas2 = Canvas(root, width=450, height=100, bg="black")
    ...
    canvas5 = Canvas(root, width=450, height=70, bg="black")
    canvas5.grid(row=3,column=0)
    
    canvas6 = Canvas(root, width=450, height=70, bg="black")
    canvas6.grid(row=3,column=1)
    
    canvas7 = Canvas(root, width=450, height=150, bg="black")
    canvas7.grid(row=4,column=0)
    
    canvas8 = Canvas(root, width=450, height=150, bg="black")
    canvas8.grid(row=4,column=1)

    canvas9 = Canvas(root,width=900,height=100, bg="black")
    ...
    canvas1.create_text(77,100,fill="green",font=("Ariel",12), text="Version: {}".format(monitor_system_info.version))
    ...
    canvas3.create_text(65, 30,fill="green",font=("Ariel",12), text="Processor: {}".format(proc_info.Name))
    ...
    canvas7.create_text(105,40, fill="green",font=("Ariel",12, font.BOLD), text=gpu_info.Name)

    canvas8.create_text(80,15, fill="green",font=("Ariel",12, font.BOLD), text="Internet Speed Test")

    mylabel1 = tk.Label(fg="green",font=("Ariel,",12,font.BOLD),text = "Click the speed test to run!",bg="black")
    ...
    def speed_test():
        ...
        mylabel1.config(fg="green",font=("Ariel",12),text = f"Found: {best['host']} Located in {best['country']}")
